...
API_ID = int(environ.get('API_ID', '27669980'))
API_HASH = environ.get('API_HASH', 'e267e13a98b9753b59328e08210ab62f')
BOT_TOKEN = environ.get('BOT_TOKEN', "7940158747:AAEKgDF1tTmHU0FS761AXK54jtsm9N3T4cI")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.imghippo.com/files/TN1241fI.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6960762506').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002490996722').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002449258280').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002490996722') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002490996722')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rk6848148607:rk6848148607@cluster0.ki7fw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/HOLLYWOOD_UPDETE')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Main_chenal')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Main_chenal') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Rohit_chaudhar')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.CAPTION}\n\n👇👇👇👇👇👇👇👇👇👇\n🌟 Movie Request Group 🌟\nhttps://t.me/group_chaudhary\n🌟 OTT Update Channel 🌟\nhttps://t.me/Main_chenal\n🅼🆁🅺 Share And Support\n😊👍")
